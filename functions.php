...
function popProductsList() {
	...
	if($results) {
		...
		echo "<p>Il n'y a pas de produit a afficher,ajouter des produit svp.</p>";
...
function popCustomersList() {
	...
	if($results) {
		...
		echo "<p>Il n'y a pas de client a afficher.</p>";
...
function getProducts() {
	...
	if($results) {
		...
		echo "<p>Il n'y a pas de produit a afficher.</p>";
...
function getUsers() {
	...
	if($results) {
		...
		echo "<p>Il n'y a pas d'utilisateur a afficher.</p>";
