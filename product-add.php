			...
			<div class="panel-body form-group form-group-sm">
				<form method="post" id="add_product">
					...
					<div class="row">
						...
						<div class="col-xs-4">
							<input type="text" class="form-control required" name="product_desc" placeholder="Description du produit">
						</div>
						<div class="col-xs-4">
					...
					<div class="row">
						<div class="col-xs-12 margin-top btn-group">
							<input type="submit" id="action_add_product" class="btn btn-success float-right" value="Ajouter" data-loading-text="Adding...">
						</div>
					</div>
				</form>
			</div>
