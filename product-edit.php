	...
	<div class="col-xs-12">
		<div class="panel panel-default">
			<div class="panel-heading">
				<h4>Modifier Produit (<?php echo $getID; ?>)</h4>
			</div>
			<div class="panel-body form-group form-group-sm">
				<form method="post" id="update_product">
					...
					<div class="row">
						...
						<div class="col-xs-4">
							<input type="text" class="form-control required" name="product_desc" placeholder="description du produit" value="<?php echo $product_desc; ?>">
						</div>
						<div class="col-xs-4">
					...
					<div class="row">
						<div class="col-xs-12 margin-top btn-group">
							<input type="submit" id="action_update_product" class="btn btn-success float-right" value="Modifier" data-loading-text="Updating...">
						</div>
					</div>
				</form>
			</div>
